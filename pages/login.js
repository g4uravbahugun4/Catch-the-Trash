        ...
        <>
            ...
            <section className='bg-cyan-400 h-screen flex flex-col  relative z-0 '>
                ...
                <div className='m-auto'>
                    ...
                    <div className='text-gray-600 text-2xl font-semibold flex justify-center'>Dont have an account?  </div>
                    <div className='text-gray-600 w-fit ml-[35%] text-2xl hover:text-violet-900 font-semibold hover:font-bold flex justify-center'><Link href="/signup">Create account </Link></div>
                </div>
            </section>
        </>
    );
